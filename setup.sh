...
IPVPS=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
res10() {
wget https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/noobz/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
KEY="7444777420:AAHFFQqI-7KcUBaXplx0kvcHBz9Rw9AlSSs"
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER","url":"https://t.me/paintechvpn"},{"text":"CHANNEL","url":"https://t.me/channelpaintech"}]]}'
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/versi  )
