...
res2() {
wget https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/slowdns/pain1.sh && chmod +x pain1.sh && ./pain1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/slowdns/pain2.sh && chmod +x pain2.sh && ./pain2.sh
clear
}
clear
echo -e "$COLOR1╭══════════════════════════════════════════╮${NC}"
...
clear
echo -e  "$COLOR1╭══════════════════════════════════════════╮${NC}"
echo -e  "$COLOR1│  \033[1;37mcontoh domain xx.vip-server.cloud       $COLOR1│${NC}"
...
if [[ $dobot == "1" ]]; then
clear
wget https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/dobot/install.sh &> /dev/null
chmod +x install.sh
bash install.sh
rm -rf install.sh
fi
...
echo -e " $COLOR1║${NC} ${WH}[${COLOR1}17${WH}]${NC} ${COLOR1}• ${WH}FIX SLOWDNS OFF${WH}            ${WH}[${COLOR1}99${WH}]${NC} ${COLOR1}• ${WH}CLEAR RAM CACHE ${WH}   $COLOR1║ $NC"
echo -e " $COLOR1╚══════════════════════════════════════════════════════╝${NC}"
echo -e ""
...
17 |17) clear ; wget https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/slowdns/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh ; exit ;;
