...
MYIP=$(wget -qO- ifconfig.me)
Isadmin=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
Name=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $2}')
...
clear
LIST=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key | grep $kode | awk '{print $6}')
U2=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini | grep $MYIP | awk '{print $6}')
MYIP=$(curl -sS ipv4.icanhazip.com)
web=$(curl -sS  https://raw.githubusercontent.com/ptchnew/licensi/main/key  | grep $kode | awk '{print $3}')
web2=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key  | grep $kode | awk '{print $2}')
web3=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key  | grep $kode | awk '{print $4}')
web4=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key  | grep $kode | awk '{print $5}')
web5=$(curl -sS https://raw.githubusercontent.com/ptchnew/licensi/main/key  | grep $kode | awk '{print $6}')
...
mkdir /root/rmbl
cd /root/rmbl
wget https://raw.githubusercontent.com/Hionepaintech/Licensing-/main/ipmini >/dev/null 2>&1
if [ "$U4" = "$MYIP" ]; then
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/menu/install-up.sh &> /dev/null
