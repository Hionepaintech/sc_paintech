...
echo -e " $COLOR1╰════════════════════════════════════════════════════════╯${NC}"
echo -e "         $COLOR1╭═══════════════════════════════════════╮${NC}"
echo -e "         $COLOR1│${NC} ${WH}SSH WS/WSS :${status_ws} ${WH}V2RAY :${status_xray} ${WH}NOOBZVPN :${stat_noobz} $COLOR1│${NC}"
echo -e "         $COLOR1│${NC} ${WH}UDP CUSTOM :${status_udp} ${WH}NGINX :${status_nginx} ${WH}DROPBEAR :${status_beruangjatuh} $COLOR1│${NC}"
echo -e "         $COLOR1╰═══════════════════════════════════════╯${NC}"
echo -e "        $COLOR1╭═════════════════════════════════════╮${NC}"
echo -e "        $COLOR1│$NC${WH}  SSH/OPVPN   =  ${COLOR1}$total_ssh ${NC}${WH} ACCOUNT $COLOR1│${NC}"
echo -e "        $COLOR1│$NC${WH}  VMESS/WS    =  ${COLOR1}$vmess ${NC}${WH} ACCOUNT $COLOR1│${NC}"
echo -e "        $COLOR1│$NC${WH}  VLESS/WS    =  ${COLOR1}$vless ${NC}${WH} ACCOUNT $COLOR1│${NC}"
echo -e "        $COLOR1│$NC${WH}  TROJAN/GRPC =  ${COLOR1}$trtls ${NC}${WH} ACCOUNT$COLOR1│${NC}"
echo -e "        $COLOR1│$NC${WH}  NOOBZVPNS   =  ${COLOR1}$jumlah_noobz ${NC}${WH} ACCOUNT$COLOR1│${NC}"
echo -e "        $COLOR1╰═════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭════════════════════════════════════════════════════════╮${NC}"
