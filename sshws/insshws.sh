...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/sshws/ws-ovpn.py
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/Hionepaintech/sc_paintech/main/sshws/ws-stunnel
